...
archrgs_module_desc="N64 emulator MUPEN64Plus"
...
function configure_rgs-em-mupen64plus() {
    ...
    # copy that to rgs-dist and put the original config back again. We then make any ini changes
    # on the rgs-dist file. This preserves any user configs from modification and allows us to have
