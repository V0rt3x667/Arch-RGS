...
function init_input_rgs-fe-emulationstation() {
    local es_config="$(_get_input_cfg_rgs-fe-emulationstation)"
...
function copy_inputscripts_rgs-fe-emulationstation() {
    ...
    cp -r "$scriptdir/scriptmodules/$md_type/rgs-fe-emulationstation/"* "$md_inst/scripts/"
...
_EOF_
    ...
    cp "$scriptdir/scriptmodules/$md_type/rgs-fe-emulationstation/Arch-RGS.svg" "/usr/local/share/icons/"
