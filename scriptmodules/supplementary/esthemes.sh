...
archrgs_module_id="esthemes"
archrgs_module_desc="Install themes for Emulation Station"
        ...
        case "$choice" in
            ...
            U)
                for theme in "${installed_themes[@]}"; do
                    theme=($theme)
                    archrgs_callModule esthemes install_theme "${theme[0]}" "${theme[1]}"
                done
                ;;
            *)
                ...
                if [[ "${status[choice]}" == "i" ]]; then
                    ...
                    case "$choice" in
                        1)
                            archrgs_callModule esthemes install_theme "$theme" "$repo"
                            ;;
                        2)
                            archrgs_callModule esthemes uninstall_theme "$theme"
                            ;;
                    esac
                else
                    archrgs_callModule esthemes install_theme "$theme" "$repo"
