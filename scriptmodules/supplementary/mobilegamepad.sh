...
archrgs_module_id="mobilegamepad"
archrgs_module_desc="Mobile Universal Gamepad"
archrgs_module_licence="GPL3 https://raw.githubusercontent.com/sbidolach/mobile-gamepad/master/LICENSE"
