...
archrgs_module_id="rgs-lr-desmume2015"
archrgs_module_desc="NDS emu - DESMUME (2015 version)"
...
function install_bin_rgs-lr-desmume2015() {
    pacmanPkg rgs-lr-desmume2015
}

function remove_rgs-lr-desmume2015() {
    pacmanRemove rgs-lr-desmume2015
}

function configure_rgs-lr-desmume2015() {
    mkRomDir "nds"
