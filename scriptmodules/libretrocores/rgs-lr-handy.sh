...
archrgs_module_desc="Atari Lynx emulator - Handy port for libretro"
archrgs_module_help="ROM Extensions: .lnx .zip\n\nCopy your Atari Lynx roms to $romdir/atarilynx"
archrgs_module_licence="ZLIB https://raw.githubusercontent.com/libretro/libretro-handy/master/lynx/license.txt"
