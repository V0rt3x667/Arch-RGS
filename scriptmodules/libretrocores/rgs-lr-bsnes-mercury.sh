...
archrgs_module_desc="Super Nintendo emu - Fork of bsnes with various performance improvements."
...
function configure_rgs-lr-bsnes-mercury() {
    ...
    addEmulator 1 "$md_id" "snes" "$md_inst/bsnes_mercury_accuracy_libretro.so"
