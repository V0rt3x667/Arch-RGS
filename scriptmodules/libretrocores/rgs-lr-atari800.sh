...
archrgs_module_desc="Atari 8-bit/800/5200 emulator - Atari800 port for libretro"
...
function configure_rgs-lr-atari800() {
    ...
    addEmulator 1 "rgs-lr-atari800" "atari800" "$md_inst/atari800_libretro.so"
    addEmulator 1 "rgs-lr-atari800" "atari5200" "$md_inst/atari800_libretro.so"
    addSystem "atari800"
    addSystem "atari5200"
}
