...
function configure_rgs-lr-openlara() {
  ...
  mkRomDir "ports/tomb_raider"

  addPort "$md_id" "tomb_raider" "Tomb Raider" "$md_inst/openlara_libretro.so"

  [[ "$md_mode" == "remove" ]] && return

  ensureSystemretroconfig "ports/tomb_raider"
}
